...
@shop.route('/shop/request-order/<int:product_id>', methods=['GET', 'POST'])
def request_order(product_id):
    import urllib.parse
    product = Product.query.get_or_404(product_id)
    WHATSAPP_NUMBER = '2347082815719'  # ← same number
    ...
    if request.method == 'POST':
        ...
        msg = (
            ...
            f"💰 *Total:* {'₦{:,.0f}'.format(total) if total else 'Price on request'}\n"
            f"🚚 *Delivery:* {delivery}\n"
